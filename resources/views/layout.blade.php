                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    @foreach ($products as $product)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ $product->price }}</td>
                                            <td><img src="{{ asset('images/'.$product->image) }}" height="50" width="50"></td>

                                            <td><a href="{{ route('blog.post', ['id' => $product->id]) }}" class="btn btn-primary">Read</a></td>
                                            <td><a href="{{ route('admin.edit', ['id' => $product->id]) }}" class="btn btn-warning">Update</a></td>

                                            <td><a href="{{route('admin.delete',$product->id)}}" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
                                    @endif
                                    </tbody>
