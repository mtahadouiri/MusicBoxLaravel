...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo e(url('/ad')); ?>" class="logo">
            ...
            <span class="fa fa fa-youtube-play"></span>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li ><a href="<?php echo e(url('/ad')); ?>"><i class="fa fa-fw fa-list"></i> <span>Products</span></a></li>
                <li class="active"><a href="<?php echo e(url('/addProd')); ?>"><i class="fa fa-fw fa-plus-square"></i> <span>Add Product</span></a></li>
                    ...
                    <div class="box-body">
                        <form >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="<?php echo e($product->name); ?>" id="name" name="name" readonly>
                            </div>
                            <div class="form-group">
                                <label>Product Price</label>
                                <input type="text" class="form-control" placeholder="<?php echo e($product->price); ?>" id="price" name="price" readonly>
                            </div>

                            <!-- textarea -->
                            <div class="form-group">
                                <label>Product Description</label>
                                <textarea class="form-control" rows="3" placeholder="<?php echo e($product->description); ?>" id="description" name="description" readonly></textarea>
                            </div>
                            <!-- select -->
                            <div class="form-group">
                                <label>Product Type</label>
                                <input type="text" class="form-control" placeholder="<?php echo e($product->type); ?>" id="price" name="price" readonly>
                            </div>
                            <div class="form-group">
