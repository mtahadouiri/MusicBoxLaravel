    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="<?php echo e(url('/ad')); ?>"><i class="fa fa-link"></i> <span>Menu</span></a></li>
                <li ><a href="<?php echo e(route('admin.create.menu')); ?>"><i class="fa fa-link"></i> <span>Add Menu</span></a></li>
                <li ><a href="<?php echo e(route('admin.create')); ?>"><i class="fa fa-link"></i> <span>Add Product</span></a></li>
                <li ><a href="<?php echo e(route('admin.commands')); ?>"><i class="fa fa-link"></i> <span>Commandes</span></a></li>
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending"
                                        aria-label="Product Name: activate to sort column ascending" style="width: 217px;">Command description	</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Product Description: activate to sort column ascending" style="width: 237px;">Command Price</th>

                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Product Description: activate to sort column ascending" style="width: 237px;">created_at</th>
                                ...
                                <?php $__currentLoopData = $commands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $command): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($command->etat =='en attente'): ?>
                                        <tr id="<?php echo e($command->id); ?>" role="row" class="odd">

                                            <td><?php echo e($command->description); ?></td>
                                            <td><?php echo e($command->price); ?></td>
                                            <td><?php echo e($command->created_at); ?></td>
                                            <td><a id="accept" href="<?php echo e(route('admin.edit.command',$command->id)); ?>" class="btn btn-primary">Accept</a></td>
                                            <td><a href="<?php echo e(route('command.delete',$command->id)); ?>" class="btn btn-danger">Refus</a></td>
